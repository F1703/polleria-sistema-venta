...
<?php $__env->startSection('contentheader_title'); ?>
    <?php /* <div class="page-header"> */ ?>
        <h3><i class="glyphicon glyphicon-edit"></i> Provincias / Edit #<?php echo e($provincium->id); ?></h3>
    <?php /* </div> */ ?>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('main-content'); ?>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="<?php echo e(route('provincias.update', $provincium->id)); ?>" method="POST">
