...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="#"><a href="<?php echo e(url('domicilios')); ?>"><i class='fa fa-circle-o'></i> <span>Domicilio</span></a></li>
            <li class="#"><a href="<?php echo e(url('proveedors')); ?>"><i class='fa fa-circle-o'></i> <span>Proveedor</span></a></li>
