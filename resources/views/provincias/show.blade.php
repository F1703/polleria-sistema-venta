...
<div class="page-header">
        <h1>Provincias / Show #{{$provincium->id}}</h1>
        <form action="{{ route('provincias.destroy', $provincium->id) }}" method="POST" style="display: inline;" onsubmit="if(confirm('Delete? Are you sure?')) { return true } else {return false };">
            ...
            <div class="btn-group pull-right" role="group" aria-label="...">
                <a class="btn btn-warning btn-group" role="group" href="{{ route('provincias.edit', $provincium->id) }}"><i class="glyphicon glyphicon-edit"></i> Edit</a>
