...
@section('contentheader_title')
    {{-- <div class="page-header clearfix">
        <h1>
            ...
            <a class="btn btn-success pull-left" href="{{ route('provincias.create') }}"><i class="glyphicon glyphicon-plus"></i> Create</a>
        {{-- </h1>
                ...
                <table class="table table-condensed table-striped">
                    ...
                    <tbody>
                        @foreach($provincias as $provincium)
                            <tr>
                              <td>{{$provincium->id}}</td>
                              <td>{{$provincium->provincia}}</td>
                              <td>{{$provincium->idpais}}</td>
