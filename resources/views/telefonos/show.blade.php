...
<div class="page-header">
        <h1>Telefonos / Show #{{$telefono->id}}</h1>
        <form action="{{ route('telefonos.destroy', $telefono->id) }}" method="POST" style="display: inline;" onsubmit="if(confirm('Delete? Are you sure?')) { return true } else {return false };">
            ...
            <div class="btn-group pull-right" role="group" aria-label="...">
                <a class="btn btn-warning btn-group" role="group" href="{{ route('telefonos.edit', $telefono->id) }}"><i class="glyphicon glyphicon-edit"></i> Edit</a>
